...
train <- fread("/Users/macpro/Projects/data-science/rossmann-store-sales/data/train.csv",stringsAsFactors = T)
test  <- fread("/Users/macpro/Projects/data-science/rossmann-store-sales/data/test.csv",stringsAsFactors = T)
store <- fread("/Users/macpro/Projects/data-science/rossmann-store-sales/data/store.csv",stringsAsFactors = T)
